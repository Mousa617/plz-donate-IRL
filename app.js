...
async function main() {
  ...
  // Add booth button for claiming/unclaiming
  ...
  boothButton.addEventListener('click', (e) => {
    ...
    if (hasClaimedBooth) {
      // Show options - edit text or unclaim booth
      ...
      optionsModal.style.zIndex = '4000';
      ...
      optionsContent.style.maxWidth = '300px';
      optionsContent.style.textAlign = 'center';

      const title = document.createElement('h2');
      title.textContent = 'Booth Options';
      title.style.marginBottom = '20px';

      const editButton = document.createElement('button');
      editButton.textContent = 'Edit Booth Text';
      ...
      unclaimButton.textContent = 'Unclaim Booth';
      unclaimButton.style.padding = '10px 20px';
      unclaimButton.style.backgroundColor = '#f44336';
      unclaimButton.style.color = 'white';
      unclaimButton.style.border = 'none';
      unclaimButton.style.borderRadius = '5px';
      unclaimButton.style.cursor = 'pointer';
      unclaimButton.style.width = '100%';
      unclaimButton.style.marginBottom = '10px';
      ...
      unclaimButton.addEventListener('click', () => {
        document.body.removeChild(optionsModal);
        unclaimBooth(scene, claimedBoothId);
        hasClaimedBooth = false;
        boothButton.style.display = 'none';
        
        // Update presence to remove booth claim
        room.updatePresence({
          claimedBooth: null,
          boothText: null,
      ...
      optionsContent.appendChild(unclaimButton);
      optionsContent.appendChild(cancelButton);
...
function showMainMenu() {
  return new Promise((resolve) => {
    ...
    title.textContent = 'Plz Donate IRL';
    title.style.color = 'white';
    title.style.marginBottom = '20px';
    title.style.fontSize = '36px';

    const websiteLink = document.createElement('a');
    websiteLink.href = 'https://mousa617.github.io/InfiniteHorizonGames.html';
    websiteLink.textContent = 'Visit InfiniteHorizonGames Official Website';
    websiteLink.style.color = '#4CAF50';
    websiteLink.style.marginBottom = '20px';
    websiteLink.style.textDecoration = 'none';
    websiteLink.style.fontSize = '16px';
    ...
    paypalInput.style.marginBottom = '5px'; 

    const paypalError = document.createElement('p');
    paypalError.textContent = '';
    paypalError.style.color = '#f44336';
    paypalError.style.fontSize = '12px';
    paypalError.style.marginBottom = '15px';
    ...
    startButton.addEventListener('click', () => {
      ...
      if (!paypalDonationLink.startsWith('https://paypal.me/')) {
        paypalError.textContent = 'Link must start with https://paypal.me/';
